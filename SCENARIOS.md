# ARKSpace — Scenarios & Impact Matrix

> **آرك سبيس** — إدارة مساحات العمل المشتركة
> DocTypes: ~37 | APIs: ~114 | Modules: 10
...
> Total `@frappe.whitelist()` endpoints: ~114
