...
bench get-app arkspace https://github.com/sarapil/arkspace.git

# Install on site — التثبيت على الموقع
bench --site your-site.localhost install-app arkspace
...
2. **Find the App** — ابحث عن التطبيق: Look for ARKSpace icon on the desk
3. **Configure Settings** — اضبط الإعدادات: Go to ARKSpace Settings
...
- 🐛 [Report Bug](https://github.com/sarapil/arkspace/issues/new?template=bug_report.yml)
- ✨ [Request Feature](https://github.com/sarapil/arkspace/issues/new?template=feature_request.yml)
