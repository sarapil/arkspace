...
```bash
bench --site dev.localhost get-untranslated ar --app arkspace
```

### 2. Translation file format — تنسيق ملف الترجمة

File: `arkspace/translations/ar.csv`
...
bench --site dev.localhost get-untranslated ar --app arkspace | wc -l
```
...
2. Edit/create the CSV file in `arkspace/translations/`
