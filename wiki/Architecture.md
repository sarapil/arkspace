...
ARKSpace follows the Arkan Lab architecture standards built on Frappe v16.
...
class MyDocType(Document):
    def validate(self):
        from arkspace.services.my_service import MyService
...
```python
from arkspace.api.response import success, error, paginated
