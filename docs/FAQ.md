# ARKSpace — Frequently Asked Questions

## General

### What is ARKSpace?
ARKSpace is a coworking space management solution built on the Frappe Framework, designed with Arabic-first support and CAPS-based access control.
...
ARKSpace uses CAPS (Capability-Based Access Control). Assign capabilities through the CAPS user management screen.
...
### ما هو ARKSpace؟
ARKSpace هو حل Coworking Space Management مبني على إطار عمل فريب مع دعم كامل للعربية.
