...
"""
ARKSpace — Demo Data
Load/clear demo data for ARKSpace showcases.
...
def load_demo_data():
    """Load demonstration data for ARKSpace.
    ...
    try:
        ...
        frappe.db.commit()
        frappe.msgprint(_("Demo data loaded for ARKSpace"))
    finally:
...
def clear_demo_data():
    ...
    frappe.db.commit()
    frappe.msgprint(_("Demo data cleared for ARKSpace"))
